package cn.stt.dropwizard.netty.http.demo2;
...
public class HttpDemoServerHandler extends SimpleChannelInboundHandler<HttpObject> {
    ...
    private static final AsciiString COOKIE = new AsciiString("cookie");
    private static final AsciiString SET_COOKIE = new AsciiString("set_cookie");
