...
//    @Before
    public void before() throws Exception {
        ...
        client = new PreBuiltTransportClient(settings)
                .addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("192.168.1.182"), Integer.parseInt("9300")));
    }
...
//                .addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("www.wenbronk.com"), 9300));
        ...
        Settings settings = Settings.builder().put("cluster.name", "my-application") // 设置集群名
...
//                .put("client.transport.ping_timeout", 5) // 报错, ping等待时间,
                .build();
        client = new PreBuiltTransportClient(settings)
                .addTransportAddress(new InetSocketTransportAddress(new InetSocketAddress("192.168.1.182", 9300)));
        // 默认5s
        // 多久打开连接, 默认5s
